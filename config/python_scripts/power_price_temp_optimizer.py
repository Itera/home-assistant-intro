...
current_price = float(hass.states.get("sensor.nordpool_kwh_oslo_nok_2_09_0").state)
all_prices = hass.states.get("sensor.nordpool_kwh_oslo_nok_2_09_0").attributes.get('today') + hass.states.get("sensor.nordpool_kwh_oslo_nok_2_09_0").attributes.get('tomorrow')
